...
red_threshold = multithresh(150:160);    % Adjust as needed
green_threshold = multithresh(90:95);  % Adjust as needed
blue_threshold = multithresh(110:120);   % Adjust as needed
...
for i = 1:4
    ...
    resized_cropped_image = imresize(cropped_image, [50, 50]);
...
title('Final Segmented Nail Image');
